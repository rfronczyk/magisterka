...
\vskip 20pt
{\bf \Large Integration of speech processing systems in SOA-compliant environments}
\end{center}
...
\include{2/problem_analysis}
\include{5/current_solutions}
					% aims of the project
\include{6/projekt_i_implementacja}
\include{3/technologie}	
\include{8/przebieg_integracji}
\include{4/wymagania}						
